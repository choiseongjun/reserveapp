...
//            doFilterWrapped(new ReadableRequestWrapper(request), null, filterChain);
        }
        MDC.clear();
    }
    ...
    private static void logRequest(ReadableRequestWrapper request) throws IOException {
        ...
        log.info("Request : {} traceId ={} uri=[{}] content-type=[{}] ipAddress={}",
                request.getMethod(),
...
//        logPayload("Response", response.getContentType(), response.getContentInputStream());
    ...
    static String logPayload(String prefix, String contentType, InputStream inputStream) throws IOException {
...
//                log.info("pay gogo {}",contentString);
